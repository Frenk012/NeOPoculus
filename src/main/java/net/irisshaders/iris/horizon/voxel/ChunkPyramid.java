		...
		for (int y = 0; y < 16; y++) {
			for (int z = 0; z < 16; z++) {
				...
				for (int x = 0; x < 16; x++) {
					...
					// Plants and vines are kept: the mesher now gives them their
					// real shape (a cross silhouette, a vine flat on its wall)
					// instead of the floating cube that made them worth dropping.
					int cellState = stateId;
